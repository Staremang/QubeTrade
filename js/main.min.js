...
Element.prototype.viewChecker = function(e) {
    function t() {
        a = !0, r.classList.add("media-end");
    }
    function o() {
        return r.getBoundingClientRect().top <= document.documentElement.clientHeight;
    }
    var n = !1, i = !1, a = !1, r = this;
    if (function() {
        ...
        var d = function() {
            ...
            var o = l.play();
            l.style.opacity = "1", l.style.visibility = "visible", l.addEventListener("ended", t), 
        ...
        l.classList.add("mediaobject-element"), r.insertBefore(l, r.children[0]), l.addEventListener("error", function(o) {
            console.log(e, "Ошибка воспроизведения", o), t();
        }), l.addEventListener("canplaythrough", d), window.addEventListener("scroll", s), 
        window.addEventListener("resize", s), s();
    } else console.log("Вопсроизведение данного формата недоступно для вашего браузера"), 
    t();
    return this;
}, ready(function() {
