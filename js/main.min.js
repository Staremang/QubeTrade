...
Element.prototype.viewChecker = function(e) {
    ...
    if (function(e) {
        ...
        var c, r = function() {
            ...
            a ? (i = !0, l()) : c = setTimeout(function() {
                a || (t(!1, "Видео не загрузилось в указанный период"), u.removeEventListener("canplaythrough", r), 
                o());
            }, 8e3));
        }, l = function() {
            var e = u.play();
            clearTimeout(c), u.style.opacity = "1", u.style.visibility = "visible", setTimeout(function() {
                d.classList.add("media-last-frame");
            }, 500), u.addEventListener("ended", o), e instanceof Promise ? e.then(function() {
                t(!0);
            }).catch(function(e) {
                t(!1, e.message), o();
            }) : setTimeout(function() {
                s || (t(!1, "Видео слишком долго грузилось"), u.removeEventListener("canplaythrough", r), 
                o());
            }, 1e4);
        }, u = function(n) {
        ...
        u.addEventListener("canplaythrough", r), window.addEventListener("scroll", m), window.addEventListener("resize", m), 
        m();
    } else t(!1, "Воспроизведение данного формата недоступно для вашего браузера"), 
    o();
    return this;
}, ready(function() {
    svg4everybody(), console.log("v1.12 - 05.08"), -1 !== navigator.platform.indexOf("Mac") || -1 !== navigator.platform.indexOf("iPhone") ? (document.body.classList.add("ios"), 
