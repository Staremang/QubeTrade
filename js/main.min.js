...
Element.prototype.viewChecker = function(e) {
    ...
    if (function(e) {
        ...
        (c = function(o) {
            ...
            return "ios" === e.os ? (i.innerHTML += '<source src="video_ios/' + e.name + '.mp4" type="video/mp4">') : (i.innerHTML += '<source src="video_android/' + e.name + '.mp4" type="video/mp4">'),
            i.classList.add("mediaobject-element"), o.insertBefore(i, o.children[0]), i.load(), 
    ...
    svg4everybody(), console.log("v1.16 - 09.08"), -1 !== navigator.platform.indexOf("Mac") || -1 !== navigator.platform.indexOf("iPhone") ? (document.body.classList.add("ios"),
